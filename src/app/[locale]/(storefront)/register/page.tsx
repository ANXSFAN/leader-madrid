        ...
        <form onSubmit={onSubmit} className="space-y-5">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 bg-secondary border border-border rounded-xl focus:ring-2 focus:ring-accent focus:bg-card focus:border-transparent outline-none transition-all text-sm placeholder:text-muted-foreground/40"
            />
          </div>
          ...
          <div className="flex items-start gap-2.5">
            ...
            />
            <label htmlFor="privacy_consent" className="text-xs text-muted-foreground leading-relaxed">
              {t("privacy_consent_prefix")}{" "}
              <Link href="/legal/privacy" className="text-accent font-bold hover:underline" target="_blank">
                {t("privacy_policy")}
              </Link>{" "}
